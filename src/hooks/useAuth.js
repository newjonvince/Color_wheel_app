...
const warnOnce = () => {
  ...
  if (!hasWarned && typeof __DEV__ !== 'undefined' && __DEV__) {
    hasWarned = true;
    console.warn('⚠️ DEPRECATED: useAuth hook from hooks/useAuth.js is deprecated. Use AuthProvider, useAuthState, and useAuthDispatch from contexts/AuthContext.js instead.');
  }
};
